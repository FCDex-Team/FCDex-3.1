...
```toml
[[ballsdex.packages]]
location = "git+https://github.com/FCDex-Team/FCDex-3.1.git@3.1.5"
path = "fcdex_3_1"
enabled = true
```
...
- Set `path = "fcdex_3_1"` and pin the latest tag (e.g. **`@3.1.5`**).
- Run migrations through **`0020`** (battle reward daily cap).
